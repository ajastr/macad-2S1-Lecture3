...
async function compute() {
    ...
    let division = document.getElementById('division').valueAsNumber
    let h_init = document.getElementById('h_init').valueAsNumber
    let h_step = document.getElementById('h_step').valueAsNumber
    let f_rad = document.getElementById('f_rad').valueAsNumber
    let d_rad = document.getElementById('d_rad').valueAsNumber
